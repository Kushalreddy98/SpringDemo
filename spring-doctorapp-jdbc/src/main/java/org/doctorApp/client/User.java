...
public class User {
    public static void main(String[] args) throws DoctorNotFoundException, SQLException, IdNotFoundException {
        ...
        //ADD DOCTOR METHOD
        Doctor doctor=new Doctor("Manju",speciality,2800,10,1);
